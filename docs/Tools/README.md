...
## 简历编辑器
[简历编辑器](http://lovestrong.top/cveditor/#/CV)

+ 编辑完后需要及时`导出数据`
+ 再次编辑时可以`导入数据`之间储存的数据
+ 功能需求请联系greatofdream@gmail.com

## 电子书籍
+ [Web档案馆](https://web.archive.org)
+ [jiumo搜索](https://jiumodiary.org)

## OCR
+ [latex公式](https://simpletex.cn/)
